...
Edit: Hirsc hi - Die Liga

author:[midgetgrimm] drinkypoo
*/

closeDialog 0;
hintSilent parseText format["Dein Blutalkoholwert beträgt jetzt<br/> <t size='1.4'><t color='#FF0000'>%1</t></t>",[life_drink] call life_fnc_numberText];
sleep 4;

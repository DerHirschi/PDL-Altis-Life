...
(findDisplay 3100) displaySetEventHandler ["KeyDown","if ((_this select 1) isEqualTo 1) then {closeDialog 0; [] call life_fnc_ligaSetClothText;}"]; //Fix Custom Skin after ESC

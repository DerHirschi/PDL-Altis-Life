    ...
    */
    ...
    class cop_car {
        ...
        vehicles[] = {
            { "C_Offroad_01_F", "" },
            { "C_SUV_01_F", "" },
            { "C_Hatchback_01_sport_F", "life_coplevel >= 1" },
            { "B_MRAP_01_F", "life_coplevel >= 2" },
            { "B_MRAP_01_hmg_F", "life_coplevel >= 3" }
        };
    };
    ...
    class cop_air {
        ...
        vehicles[] = {
            { "B_Heli_Light_01_F", "" },
            { "B_Heli_Transport_01_F", "life_coplevel >= 4" }
        };
    };
    ...
    class cop_ship {
        ...
        vehicles[] = {
            ...
            { "C_Boat_Transport_02_F", "" }, //Apex DLC
            { "B_Boat_Armed_01_minigun_F", "life_coplevel >= 3" },
            { "B_SDV_01_F", "" }
        };
    };
};
...
class LifeCfgVehicles {
    ...
    */
    ...
    class C_Boat_Transport_02_F {
        vItemSpace = 100;
        conditions = "license_civ_boat || {!((side player) isEqualTo civilian)}";
        price = 22000;
        textures[] = {
            { "Civilian", "civ", {
    ...
    class C_Offroad_02_unarmed_F {
        vItemSpace = 65;
        conditions = "license_civ_driver || {!((side player) isEqualTo civilian)}";
        price = 12500;
        textures[] = {
            { "Black", "civ", {
    ...
    class C_Plane_Civil_01_F {
        vItemSpace = 75;
        conditions = "license_civ_pilot || {!((side player) isEqualTo civilian)}";
        price = 150000;
        textures[] = {
    ...
    class B_Heli_Transport_01_F {
        vItemSpace = 200;
        conditions = "license_cop_cAir || {!((side player) isEqualTo west)}";
        price = 200000;
        textures[] = {};
    };
    ...
    class B_Boat_Armed_01_minigun_F {
        vItemSpace = 175;
        conditions = "license_cop_cg || {!((side player) isEqualTo west)}";
        price = 75000;
        textures[] = { };
    };
    ...
    class O_Truck_03_transport_F {
        vItemSpace = 285;
        conditions = "license_civ_trucking || {!((side player) isEqualTo civilian)}";
        price = 200000;
        textures[] = { };
    };
    ...
    class B_G_Offroad_01_armed_F {
        vItemSpace = 65;
        conditions = "license_civ_rebel || {!((side player) isEqualTo civilian)}";
        price = 750000;
        textures[] = { };
    };
...
*/
    ...
    class O_Heli_Light_02_unarmed_F {
        vItemSpace = 210;
        conditions = "license_civ_pilot || {license_med_mAir} || {((side player) isEqualTo west)}";
        price = 750000;
        textures[] = {
            { "Black", "cop", {
    ...
    class B_SDV_01_F {
        vItemSpace = 50;
        conditions = "license_civ_boat || {license_cop_cg} || {((side player) isEqualTo independent)}";
        price = 150000;
        textures[] = {};
    };

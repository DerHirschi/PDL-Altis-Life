...
/* System Settings */
    ...
    bank_alac = 6500; //Amount of cash in bank for new medics
    ...
    vehicle_rental_multiplier_OPFOR = .22; // -- NOT IN USE -- Simply left in for east support.

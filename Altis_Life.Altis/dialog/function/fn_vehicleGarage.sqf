...
if (life_HC_isActive) then {
    [getPlayerUID player,(side player),_type,player] remoteExec ["HC_fnc_getVehicles",HC_Life];
} else {
    [getPlayerUID player,(side player),_type,player] remoteExec ["TON_fnc_getVehicles",RSERV];
};
